  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const champ_msgs__msg__Point * ros_message = static_cast<const champ_msgs__msg__Point *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_champ_msgs__msg__Point(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  champ_msgs__msg__Point * ros_message = static_cast<champ_msgs__msg__Point *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_champ_msgs__msg__Point(cdr, ros_message);
}
