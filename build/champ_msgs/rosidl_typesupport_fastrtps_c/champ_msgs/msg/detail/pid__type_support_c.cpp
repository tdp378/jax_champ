...
bool cdr_serialize_champ_msgs__msg__PID(
  const champ_msgs__msg__PID * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
bool cdr_deserialize_champ_msgs__msg__PID(
  eprosima::fastcdr::Cdr & cdr,
  champ_msgs__msg__PID * ros_message)
{
  // Field name: p
  {
    cdr >> ros_message->p;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
bool cdr_serialize_key_champ_msgs__msg__PID(
  const champ_msgs__msg__PID * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: p
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
size_t get_serialized_size_key_champ_msgs__msg__PID(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PID__ros_msg_type * ros_message = static_cast<const _PID__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
size_t max_serialized_size_key_champ_msgs__msg__PID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const champ_msgs__msg__PID * ros_message = static_cast<const champ_msgs__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_champ_msgs__msg__PID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  champ_msgs__msg__PID * ros_message = static_cast<champ_msgs__msg__PID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_champ_msgs__msg__PID(cdr, ros_message);
}
