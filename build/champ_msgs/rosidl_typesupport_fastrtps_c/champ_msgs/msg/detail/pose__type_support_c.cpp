...
bool cdr_serialize_champ_msgs__msg__Pose(
  const champ_msgs__msg__Pose * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
bool cdr_deserialize_champ_msgs__msg__Pose(
  eprosima::fastcdr::Cdr & cdr,
  champ_msgs__msg__Pose * ros_message)
{
  // Field name: x
  {
    cdr >> ros_message->x;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
bool cdr_serialize_key_champ_msgs__msg__Pose(
  const champ_msgs__msg__Pose * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: x
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
size_t get_serialized_size_key_champ_msgs__msg__Pose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pose__ros_msg_type * ros_message = static_cast<const _Pose__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_champ_msgs
size_t max_serialized_size_key_champ_msgs__msg__Pose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const champ_msgs__msg__Pose * ros_message = static_cast<const champ_msgs__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_champ_msgs__msg__Pose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  champ_msgs__msg__Pose * ros_message = static_cast<champ_msgs__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_champ_msgs__msg__Pose(cdr, ros_message);
}
